...
<div class="p-5 pt-5">
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
      <a class="btn btn-success btn-lg fa-solid fa-print" href="laporan.php"></a>
    </div>
...
include "config.php";
$nomor = 1;
$query = mysqli_query($db,"SELECT peminjaman.id, peminjaman.id_barang, peminjaman.nama_barang, peminjaman.nama_peminjam,peminjaman.tanggal_peminjaman, peminjaman.tanggal_pengembalian, peminjaman.status, peminjaman.jumlah FROM peminjaman");                  
